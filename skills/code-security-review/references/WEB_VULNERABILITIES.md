# Web Vulnerabilities Catalog (100 vulns by category)

Reference for systematic vulnerability identification, impact assessment, and
remediation guidance. Content organized into 15 major vulnerability categories
aligned with industry standards (OWASP Top 10, CWE/SANS Top 25) and real-world
attack patterns.

Pair with `DESIGN_CONTROLS.md` for proactive controls per framework and
`TESTING_PHASES.md` for active probes against a live target.
...
OWASP Web Top 10 **2025** (final). SSRF is consolidated into A01; Software Supply Chain Failures (A03) broadens the old "Vulnerable & Outdated Components"; A10 Mishandling of Exceptional Conditions is new (error-handling / fail-open / info-leak).

| OWASP 2025 | Related Vulnerabilities |
| :--- | :--- |
| A01: Broken Access Control (incl. SSRF) | 40-44, 23, 74, 66, 87-88 |
...
| A07: Authentication Failures | 14-23, 85-86 |
| A08: Software or Data Integrity Failures | 45-47 |
| A09: Logging & Alerting Failures | 73 |
| A10: Mishandling of Exceptional Conditions | 33, 92-93, 96 |
